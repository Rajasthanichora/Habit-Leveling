...
const styles = StyleSheet.create({
  ...
  statusRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flex: 1, justifyContent: 'flex-end' },
  statusDot: { width: 8, height: 8, borderRadius: 4, opacity: 0.8 },
  statusLabel: { fontSize: FontSize.xs, fontWeight: FontWeight.medium, opacity: 0.85, maxWidth: 180 },
  scrollContent: { padding: Spacing.md, gap: Spacing.md },

  // Cards
  chatCard: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.card,
    borderRadius: Radius.lg, padding: Spacing.md, borderWidth: 1, borderColor: Colors.cardBorder, gap: Spacing.md,
  },
  chatCardIcon: {
    width: 48, height: 48, borderRadius: 14, backgroundColor: 'rgba(41,121,255,0.1)',
    justifyContent: 'center', alignItems: 'center',
  },
  chatCardInfo: { flex: 1, gap: 2 },
  chatCardTitle: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: Colors.textPrimary },
  chatCardDesc: { fontSize: FontSize.xs, color: Colors.textMuted },
  ...
  analyzeBtnText: { fontSize: FontSize.md, fontWeight: FontWeight.bold, color: '#fff' },
  ...
  autoStatusText: { fontSize: FontSize.xs, color: Colors.warning, fontWeight: FontWeight.medium },
  ...
  // Suggestions
  suggestionsHeader: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, marginTop: Spacing.sm },
  suggestionsTitle: { fontSize: FontSize.sm, fontWeight: FontWeight.bold, color: Colors.textPrimary },
  ...
  habitCard: {
    ...
    borderColor: Colors.cardBorder, borderLeftWidth: 4, gap: Spacing.sm,
  },
  habitCardTop: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm },
  aiBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: Radius.sm },
  aiBadgeText: { fontSize: FontSize.xs, color: '#fff', fontWeight: FontWeight.bold },
  habitCardInfo: { flex: 1, gap: 2 },
  habitCardTitle: { fontSize: FontSize.sm, fontWeight: FontWeight.bold },
  habitCardName: { fontSize: FontSize.xs, color: Colors.textSecondary },
  priorityTag: {
    alignSelf: 'flex-start', borderRadius: Radius.full, paddingHorizontal: 10, paddingVertical: 3,
  },
  ...
  chatModalCloseBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.surface, justifyContent: 'center', alignItems: 'center' },
  ...
  chatBubbleAI: { backgroundColor: Colors.card, alignSelf: 'flex-start', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: Colors.cardBorder },
  ...
  // Context Toggle
  inputBar: {
    flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm,
    borderTopWidth: 1, borderTopColor: Colors.separator, gap: Spacing.sm, backgroundColor: Colors.background,
  },
  chatInput: {
    flex: 1, backgroundColor: Colors.inputBg, borderWidth: 1, borderColor: Colors.inputBorder,
    borderRadius: Radius.lg, paddingHorizontal: Spacing.md, paddingVertical: 10, color: Colors.textPrimary,
  ...
  settingsContent: { padding: Spacing.md, gap: Spacing.lg },
  ...
  subSetting: { gap: Spacing.sm },
  subSettingLabel: { fontSize: FontSize.sm, color: Colors.textSecondary },
  smallOptionBtn: {
  ...
  dayBtn: {
    width: 42, height: 36, borderRadius: Radius.sm,
    backgroundColor: Colors.chipBg, borderWidth: 1, borderColor: Colors.cardBorder,
    justifyContent: 'center', alignItems: 'center',
  },
  ...
  historySummary: { fontSize: FontSize.xs, color: Colors.textSecondary, marginTop: 1 },
  historyMeta: { fontSize: FontSize.xs, color: Colors.textMuted, marginTop: 1 },
  emptyHint: { fontSize: FontSize.sm, color: Colors.textMuted, textAlign: 'center', paddingVertical: Spacing.md },
});
